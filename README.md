...
| createConsumerSecret | consumerUuid | [link](https://iotery.io/v1/docs#createConsumerSecret) | Create a consumer secret for authentication. |
...
| createSetting | deviceUuid | [link](https://iotery.io/v1/docs#createSetting) | Create a setting for a device. |
...
| createNotificationType |  | [link](https://iotery.io/v1/docs#createNotificationType) | Create a notification type. |
| createNotificationField |  | [link](https://iotery.io/v1/docs#createNotificationField) | Create a notification field. |
...
| clearUnexecutedCommandInstances | deviceUuid | [link](https://iotery.io/docs/account-manager#tag/Devices/paths/~1devices~1:deviceUuid~1clear-unexecuted-command-instances/post) | Clears all unexecuted command instances from a given device |
...
| getCommandInstanceList |  | [link](https://iotery.io/v1/docs#getCommandInstanceList) | Get a list of command instances. |
...
| getNotificationInstance | notificationInstanceUuid | [link](https://iotery.io/v1/docs#getNotificationInstance) | Get a notification instance by uuid. |
| getSetting | settingUuid | [link](https://iotery.io/v1/docs#getSetting) | Get a setting by uuid. |
...
| getNotificationTypeList |  | [link](https://iotery.io/v1/docs#getNotificationTypeList) | Get a list of available notification types. |
| getNotificationType | notificationTypeUuid | [link](https://iotery.io/v1/docs#getNotificationType) | Get a notification type by uuid. |
| getNotificationFieldList |  | [link](https://iotery.io/v1/docs#getNotificationFieldList) | Get a list of available notification fields. |
| getNotificationField | notificationFieldUuid | [link](https://iotery.io/v1/docs#getNotificationField) | Get a notification field by uuid. |
...
| getChildGroupingList | groupingUuid | [link](https://iotery.io/v1/docs#getChildGroupingList) | Get a list of child groupings for a grouping. |
...
| getWebhookActionTypeList |  | [link](https://iotery.io/v1/docs#getWebhookActionTypeList) | Get a list of webhook action types. |
| getWebhookActionType | webhookActionTypeUuid | [link](https://iotery.io/v1/docs#getWebhookActionType) | Get a webhook action type by uuid. |
...
| updateNotificationInstance | notificationInstanceUuid | [link](https://iotery.io/v1/docs#updateNotificationInstance) | Update a notification instance. |
| updateSetting | settingUuid | [link](https://iotery.io/v1/docs#updateSetting) | Update a setting. |
...
| updateNotificationType | notificationTypeUuid | [link](https://iotery.io/v1/docs#updateNotificationType) | Update a notification type by uuid. |
| updateNotificationField | notificationFieldUuid | [link](https://iotery.io/v1/docs#updateNotificationField) | Update a notification field by uuid. |
...
| deleteConsumerSecretList | consumerUuid | [link](https://iotery.io/v1/docs#deleteConsumerSecretList) | Delete all stored consumer secrets. |
...
| deleteNotificationInstance | notificationInstanceUuid | [link](https://iotery.io/v1/docs#deleteNotificationInstance) | Delete a notification instance by uuid. |
| deleteSetting | settingUuid | [link](https://iotery.io/v1/docs#deleteSetting) | Delete a setting by uuid. |
...
| deleteNotificationType | notificationTypeUuid | [link](https://iotery.io/v1/docs#deleteNotificationType) | Delete a notification type by uuid. |
| deleteNotificationField | notificationFieldUuid | [link](https://iotery.io/v1/docs#deleteNotificationField) | Delete a notification field by uuid. |
